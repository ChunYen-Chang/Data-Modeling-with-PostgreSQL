...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplay (songplay_id varchar, start_time bigint, \
                                                                 user_id varchar, level varchar, \
                                                                 song_id varchar, artist_id varchar, \
                                                                 session_id int, location varchar, \
                                                                 user_agent varchar)""")

user_table_create = ("""CREATE TABLE IF NOT EXISTS "user" (user_id varchar, first_name varchar, \
                                                         last_name varchar, gender varchar, 
                                                         level varchar)""")

song_table_create = ("""CREATE TABLE IF NOT EXISTS song (song_id varchar, title varchar, \
                                                         artist_id varchar, year int, \
                                                         duration float)""")

artist_table_create = ("""CREATE TABLE IF NOT EXISTS artist (artist_id varchar, name varchar, \
